...
public class HttpMain {
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    interface TaskController {
      ...
      void getAllTasks(Actor<Response<List<Task>>> reply);

      @RequestMapping(path = "/tasks", method = POST)
      void createTask(@RequestBody TaskWithoutId user, Actor<Response<Task>> reply);

      @RequestMapping(path = "/tasks/{id}", method = DELETE)
      void deleteTask(@PathVariable("id") String id, Actor<Response<Void>> reply);
    }
    var actor = Actor.of(TaskController.class)
        .behavior(context -> new TaskController() {
          ...
          @Override
          public void createTask(TaskWithoutId taskWithoutId, Actor<Response<Task>> reply) {
          ...
          @Override
          public void deleteTask(String id, Actor<Response<Void>> reply) {
